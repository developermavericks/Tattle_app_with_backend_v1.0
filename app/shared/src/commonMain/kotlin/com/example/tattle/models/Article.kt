...
data class CuratedArticle(
    ...
    @SerialName("blur_hash") val blurHash: String = "L6PZfSi_00%M00wb~q_400%M_3%M",
    @SerialName("aspect_ratio") val aspectRatio: Float = 1.77f,
...
data class Article(
    ...
    val imageUrl: String,
    val blurHash: String = "L6PZfSi_00%M00wb~q_400%M_3%M",
